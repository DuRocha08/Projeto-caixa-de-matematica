const bancoDeDadosGavetas = {
    ...
    gaveta2: {
        titulo: "JOGOS E RECURSOS DIGITAIS",
        introducao: "Esta gaveta reúne uma seleção de jogos físicos, brincadeiras motoras, plataformas e recursos digitais voltados para o ensino de Matemática nos Anos Iniciais do Ensino Fundamental. O objetivo é apresentar estratégias pedagógicas dinâmicas e lúdicas que integram o movimento corporal, o cálculo mental, o raciocínio lógico-dedutivo e a manipulação concreta ou interativa, promovendo uma aprendizagem ativa e engajadora.",
        conteudo: [
    ...
    gaveta3: {
        ...
        conteudo: [
            { subtitulo: "Vídeo 1 - Descobrindo a adição", texto: 'Link: <a href="https://www.youtube.com/watch?v=5VoXOFosETI" target="_blank" style="color: var(--strawberry); font-weight: bold; text-decoration: underline;">https://youtu.be/5VoXOFosETI</a><br>O vídeo apresenta a adição de maneira simples, trabalhando a ideia de juntar e acrescentar quantidades. É adequado para introduzir o conceito antes de partir para contas mais complexas.<br>BNCC: EF01MA06 e EF01MA08.' },
            { subtitulo: "Vídeo 2 - Unidade e dezena", texto: 'Link: <a href="https://www.youtube.com/watch?v=OI7tkPBHmoI" target="_blank" style="color: var(--strawberry); font-weight: bold; text-decoration: underline;">https://youtu.be/O17tkPBHmol</a><br>Canal: Alfabrinca. Trabalha unidades, dezenas, contagem e composição de números, ajudando a criança a entender o valor dos algarismos.<br>BNCC: EF01MA01, EF01MA02, EF01MA05 e EF01MA07.' },
            { subtitulo: "Vídeo 3 - Quiz das formas geométricas", texto: 'Link: <a href="https://www.youtube.com/watch?v=sXfj2Qh88h0" target="_blank" style="color: var(--strawberry); font-weight: bold; text-decoration: underline;">https://youtu.be/sXfj2Qh88h0</a><br>O vídeo utiliza um quiz, tornando a aprendizagem mais divertida e participativa. Trabalha figuras como círculo, quadrado, triângulo e retângulo, relacionando-as ao cotidiano.<br>BNCC: EF01MA14.' },
            { subtitulo: "Vídeo 4 - Soma com dinossauros", texto: 'Link: <a href="https://www.youtube.com/watch?v=prsJNR0Zbqg" target="_blank" style="color: var(--strawberry); font-weight: bold; text-decoration: underline;">https://youtu.be/prsJNROZbqg</a><br>Canal: Smile and Learn - Português. Ensina adição de forma lúdica, utilizando dinossauros para chamar a atenção das crianças. Também apresenta o sinal de + e situações para praticar.<br>BNCC: EF01MA06 e EF01MA08.' },
            { subtitulo: "Vídeo 5 - Subtração com dinossauros", texto: 'Link: <a href="https://www.youtube.com/watch?v=V0NVAh4Adxs" target="_blank" style="color: var(--strawberry); font-weight: bold; text-decoration: underline;">https://youtu.be/V0NVAh4Adxs</a><br>Canal: Smile and Learn - Português. Apresenta a subtração de forma divertida, trabalhando principalmente a ideia de retirar e separar quantidades. É um bom complemento ao vídeo de adição.<br>BNCC: EF01MA06 e EF01MA08.' }
        ]
    },
    gaveta4: {
        titulo: "LITERATURA",
