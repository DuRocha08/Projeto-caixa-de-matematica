const bancoDeDadosGavetas = {
    ...
    gaveta2: {
        ...
        introducao: "Esta gaveta reúne uma seleção de jogos físicos e brincadeiras motoras voltados para o ensino de Matemática nos Anos Iniciais do Ensino Fundamental. O objetivo é apresentar estratégias pedagógicas dinâmicas e lúdicas que integram o movimento corporal, o cálculo mental e a cooperação.",
        conteudo: [
            { subtitulo: "Grupos (jogo físico de agrupamento)", texto: "<strong>Conceito matemático:</strong> desenvolvimento da contagem, noção de agrupamento e cálculo mental rápido de adição e subtração.<br><strong>Público:</strong> anos iniciais do ensino fundamental (1º ao 4º ano).<br><strong>Como usar pedagogicamente:</strong> o professor dita um número ou uma operação simples para que as crianças calculem mentalmente e se organizem fisicamente no espaço em grupos daquele tamanho exato. a dinâmica é ideal para momentos de transição e aquecimento da aula, estimulando o raciocínio rápido e a cooperação.", img: "/img/grupos.jpg" },
            { subtitulo: "Estafeta dos Números", texto: "<strong>Conceito matemático:</strong> resolução de operações básicas (adição e subtração), velocidade de cálculo mental, agilidade e precisão matemática.<br><strong>Público:</strong> anos iniciais do ensino fundamental (1º ao 5º ano).<br><strong>Como usar pedagogicamente:</strong> o professor organiza a turma em duas equipes dispostas em filas e posiciona duas cadeiras à frente com fichas de problemas matemáticos. ao sinal, o primeiro aluno de cada fila corre até a cadeira, resolve a operação de um cartão e retorna para dar a vez ao próximo colega. vence a equipe que finalizar a pilha de cartões primeiro com o maior número de acertos. a atividade promove o trabalho em equipe, o raciocínio rápido e integra o movimento corporal ao aprendizado do cálculo mental.", img: "/img/estafeta.jpg" }
        ]
    },
    gaveta3: {
        ...
        conteudo: [
            { subtitulo: "Escola Games (Site)", texto: "<strong>Conceito matemático:</strong> operações fundamentais (adição, subtração, multiplicação e divisão), cálculo mental, resolução de problemas.<br><strong>Público:</strong> anos Iniciais do Ensino Fundamental (1º ao 5º ano).<br><strong>Como usar pedagogicamente:</strong> o professor pode selecionar o jogo correspondente à operação que está a ser lecionada para reforçar o cálculo mental e a automatização do básico de forma lúdica. os jogos podem ser utilizados no laboratório de informática, em tablets na sala de aula ou como tarefa complementar de fixação do conteúdo.", img: "/img/escolagames.jpg" },
            { subtitulo: "IXL Learning (Programa de Matemática Completo Online)", texto: "<strong>Conceito Matemático:</strong> Desenvolvimento progressivo do pensamento matemático, incluindo contagem inicial, contagem de conjuntos, sequências numéricas, operações fundamentais, geometria e frações.<br><strong>Público:</strong> Educação Infantil (Pré-Escola) e Anos Iniciais do Ensino Fundamental (1º ao 6º ano).<br><strong>Como usar pedagogicamente:</strong> o professor pode navegar pelos níveis de ensino para direcionar atividades de acordo com a etapa de aprendizagem de cada turma ou aluno. o site é ideal para acompanhamento contínuo e diagnóstico de habilidades, permitindo às crianças realizarem os exercícios interativos com auxílio de áudio explicativo.", img: "/img/ixl.jpg" }
        ]
    },
    gaveta4: {
